...
const Sell = () => {
  ...
  const handleSubmission = async (e) => {
    ...
    try {
      // NOTE: If your backend expects images later, you will need to use new FormData() 
      // instead of a plain JavaScript object. For now, matching your exact JSON payload:
      ...
      // Reset state ONLY on successful submission
      setCurrentStep(1);
      setFormData({
        petName: '',
        petType: '',
      ...
      const serverMessage = err.response?.data?.message || "Server is unreachable.";
          ...
          <div className="col-md-6">
            <div className="step-card">
              ...
              <p className="fst-italic text-secondary">
                ...
                empirical, and helped me stay in touch with Max's new family. Highly recommend!"
              </p>
              <div className="mt-3">
