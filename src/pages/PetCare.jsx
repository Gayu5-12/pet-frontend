...
export default function PetCare() {
  ...
  const handleDispatchBooking = async (e) => {
    e.preventDefault();
    ...
    try {
      ...
      await api.post("/service-appointments", {
        petName: serviceAppointment.petName,
        petType: serviceAppointment.petType,
        clientName: serviceAppointment.clientName,
        contact: userEmail,
        date: serviceAppointment.date,
        time: serviceAppointment.time,
        branch: serviceAppointment.branch,
      ...
      alert("Error booking service appointment. Please try again.");
    }
